...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname |1422|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
...
;; search-bt : number BT -> boolean
;; 读入一个数和一颗 BT,判断这个数是否在树中出现，如果出现则返回这个节点的 pn
